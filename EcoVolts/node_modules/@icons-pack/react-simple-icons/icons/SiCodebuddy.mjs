...
const SiCodebuddy = React.forwardRef(function SiCodebuddy2({ title = "CodeBuddy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
