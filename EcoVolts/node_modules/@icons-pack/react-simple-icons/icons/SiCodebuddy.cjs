...
const defaultColor = "#6C4DFF";
const SiCodebuddy = React__namespace.forwardRef(function SiCodebuddy2({ title = "CodeBuddy", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
