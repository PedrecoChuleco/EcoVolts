...
const SiAwait = React.forwardRef(function SiAwait2({ title = "Await", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
