...
const SiDify = React__namespace.forwardRef(function SiDify2({ title = "Dify", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
