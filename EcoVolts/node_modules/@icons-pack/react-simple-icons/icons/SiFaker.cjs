...
const SiFaker = React__namespace.forwardRef(function SiFaker2({ title = "Faker", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
