...
const defaultColor = "#B8EE4B";
const SiLocust = React.forwardRef(function SiLocust2({ title = "Locust", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
