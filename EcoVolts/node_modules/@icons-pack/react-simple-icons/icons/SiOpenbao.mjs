...
const SiOpenbao = React.forwardRef(function SiOpenbao2({ title = "OpenBao", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
