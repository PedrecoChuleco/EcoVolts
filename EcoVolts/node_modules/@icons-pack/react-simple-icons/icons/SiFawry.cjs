...
const SiFawry = React__namespace.forwardRef(function SiFawry2({ title = "Fawry", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
