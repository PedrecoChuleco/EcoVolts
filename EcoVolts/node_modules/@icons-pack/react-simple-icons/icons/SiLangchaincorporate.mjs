...
const SiLangchaincorporate = React.forwardRef(function SiLangchaincorporate2({ title = "LangChain Corporate", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
