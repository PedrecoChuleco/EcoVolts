...
const SiCinny = React.forwardRef(function SiCinny2({ title = "Cinny", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
