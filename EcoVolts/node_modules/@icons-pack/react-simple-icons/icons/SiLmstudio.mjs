...
const SiLmstudio = React.forwardRef(function SiLmstudio2({ title = "LM Studio", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
