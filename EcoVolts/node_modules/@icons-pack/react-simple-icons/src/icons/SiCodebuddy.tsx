    ...
    type SiCodebuddyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiCodebuddy: IconType = React.forwardRef<SVGSVGElement, SiCodebuddyProps>(function SiCodebuddy({title = 'CodeBuddy', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
