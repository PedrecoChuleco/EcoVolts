    ...
    type SiLangchaincorporateProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#7FC8FF';

    const SiLangchaincorporate: IconType = React.forwardRef<SVGSVGElement, SiLangchaincorporateProps>(function SiLangchaincorporate({title = 'LangChain Corporate', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiLangchaincorporate as default, defaultColor };
