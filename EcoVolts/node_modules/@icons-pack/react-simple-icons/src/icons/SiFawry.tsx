    ...
    type SiFawryProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FFD300';

    const SiFawry: IconType = React.forwardRef<SVGSVGElement, SiFawryProps>(function SiFawry({title = 'Fawry', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFawry as default, defaultColor };
