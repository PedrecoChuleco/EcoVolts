    ...
    type SiOpenbaoProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#336D5C';

    const SiOpenbao: IconType = React.forwardRef<SVGSVGElement, SiOpenbaoProps>(function SiOpenbao({title = 'OpenBao', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
