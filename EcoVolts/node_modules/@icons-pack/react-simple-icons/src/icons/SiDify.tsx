    ...
    type SiDifyProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDify: IconType = React.forwardRef<SVGSVGElement, SiDifyProps>(function SiDify({title = 'Dify', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
