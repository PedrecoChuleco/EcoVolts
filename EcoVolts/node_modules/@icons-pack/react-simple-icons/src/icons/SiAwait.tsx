    ...
    type SiAwaitProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#7858F5';

    const SiAwait: IconType = React.forwardRef<SVGSVGElement, SiAwaitProps>(function SiAwait({title = 'Await', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiAwait as default, defaultColor };
