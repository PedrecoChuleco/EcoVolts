    ...
    type SiFakerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#779B2E';

    const SiFaker: IconType = React.forwardRef<SVGSVGElement, SiFakerProps>(function SiFaker({title = 'Faker', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFaker as default, defaultColor };
