    ...
    type SiFluxerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#4641D9';

    const SiFluxer: IconType = React.forwardRef<SVGSVGElement, SiFluxerProps>(function SiFluxer({title = 'Fluxer', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiFluxer as default, defaultColor };
