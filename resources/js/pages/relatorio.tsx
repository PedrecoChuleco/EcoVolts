                ...
                <div className="flex flex-wrap items-center justify-between gap-4 px-8 pt-[18px] pb-[26px]">
                    <span
                        className={`inline-flex items-center gap-2 rounded-full border px-4 py-2 text-[13.5px] ${
                            report.roof_fits
                                ? 'border-[rgba(154,214,183,0.4)] bg-[rgba(47,107,79,0.35)] text-[#4f8c68]'
                                : 'border-[rgba(232,163,61,0.4)] bg-[rgba(181,80,47,0.35)] text-[#743a1d]'
                        }`}
                    >
                    ...
                    <EcoButton href={route('dashboard')}>
                        Voltar ao menu
                    </EcoButton>
                </div>
            </EcoCard>
